...
var module;!function (e, t) {
  ...
  var n = [],
    ...
    }, (i = oe.selectors = { cacheLength: 50, createPseudo: ae, match: Y, attrHandle: {}, find: {}, relative: { ">": { dir: "parentNode", first: !0 }, " ": { dir: "parentNode" }, "+": { dir: "previousSibling", first: !0 }, "~": { dir: "previousSibling" } }, preFilter: { ATTR: function ATTR(e) {
    ...
    this.expando = w.expando + K.uid++;
      ...
      var n,
        ...
        if (void 0 !== t) {
          n = (t = Array.isArray(t) ? t.map($) : (t = $(t)) in i ? [t] : t.match(M) || []).length;for (; n--;) {
            delete i[t[n]];
          }
    ...
    t = s.apply([], t);var r,
      ...
      var o = e.eq(r);v && (t[0] = g.call(this, r, o.html())), Me(o, t, n, i);
    ...
    var i,
        ...
        o,
        s,
        a = e.style;return (n = n || Fe(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || w.contains(e.ownerDocument, e) || (s = w.style(e, t)), !p.pixelBoxStyles() && He.test(s) && qe.test(t) && (i = a.width, r = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = r, a.maxWidth = o)), void 0 !== s ? s + "" : s;
  }function Re(e, t) {
    ...
    function t() {
      ...
      $e = ["Webkit", "Moz", "ms"],
      Ye = i.createElement("div").style;function Ke(e) {
    var t = w.cssProps[e];return t || (t = w.cssProps[e] = function (e) {
      if (e in Ye) return e;for (var t = e[0].toUpperCase() + e.slice(1), n = $e.length; n--;) {
    ...
    return new Je.prototype.init(e, t, n, i, r);
      ...
      var r,
          o,
          s,
          a = $(t);return We.test(t) || (t = Ke(a)), (s = w.cssHooks[t] || w.cssHooks[a]) && "get" in s && (r = s.get(e, !0, n)), void 0 === r && (r = Be(e, t, i)), "normal" === r && t in Ve && (r = Ve[t]), "" === n || n ? (o = parseFloat(r), !0 === n || isFinite(o) ? o || 0 : r) : r;
    ...
    var i,
      ...
      m(e) ? (t = e, e = ["*"]) : e = e.match(M);for (var n, i = 0, r = e.length; i < r; i++) {
    ...
    var e = i.createElement("input"),
      ...
      var n,
          i = 0,
          r = t && t.match(M);if (r && 1 === e.nodeType) for (; n = r[i++];) {
        e.removeAttribute(n);
      }
    ...
    e.stopPropagation();
      ...
      var s,
        ...
        }return t.type = y, o || t.isDefaultPrevented() || f._default && !1 !== f._default.apply(v.pop(), n) || !Y(r) || u && m(r[y]) && !g(r) && ((l = r[u]) && (r[u] = null), w.event.triggered = y, t.isPropagationStopped() && p.addEventListener(y, vt), r[y](), t.isPropagationStopped() && p.removeEventListener(y, vt), w.event.triggered = void 0, l && (r[u] = l)), t.result;
      }
    ...
    return function (t, n) {
      "string" != typeof t && (n = t, t = "*");var i,
          r = 0,
          o = t.toLowerCase().match(M) || [];if (m(n)) for (; i = o[r++];) {
    ...
    var n,
      ...
      "object" == (typeof t === "undefined" ? "undefined" : _typeof(t)) && (n = t, t = void 0), n = n || {};var r,
        ...
        } };if (v.promise(T), p.url = ((t || p.url || yt.href) + "").replace(Nt, yt.protocol + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = (p.dataType || "*").toLowerCase().match(M) || [""], null == p.crossDomain) {
    ...
    var _n, i;if (p.cors || Bt && !t.crossDomain) return { send: function send(r, o) {
        var s,
          ...
          return function () {
            _n && (_n = i = a.onload = a.onerror = a.onabort = a.ontimeout = a.onreadystatechange = null, "abort" === e ? a.abort() : "error" === e ? "number" != typeof a.status ? o(0, "error") : o(a.status, a.statusText) : o(qt[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? { binary: a.response } : { text: a.responseText }, a.getAllResponseHeaders()));
          };
  ...
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && void 0 !== module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : e.Popper = t();
}(this, function () {
  "use strict";
  ...
  }var $ = { FLIP: "flip", CLOCKWISE: "clockwise", COUNTERCLOCKWISE: "counterclockwise" };function Y(e, t, n, i) {
    var r = [0, 0],
      ...
      e.forEach(function (n, i) {
        B(n) && (r[t] += n * ("-" === e[i - 1] ? -1 : 1));
          ...
          var n = t.offset,
              ...
              s = r.reference,
              a = i.split("-")[0],
              l = void 0;return l = B(+n) ? [+n, 0] : Y(n, o, s, a), "left" === a ? (o.top += l[0], o.left -= l[1]) : "right" === a ? (o.top += l[0], o.left += l[1]) : "top" === a ? (o.left += l[0], o.top -= l[1]) : "bottom" === a && (o.left += l[0], o.top += l[1]), e.popper = o, e;
  ...
  }();return Q.Utils = ("undefined" != typeof window ? window : global).PopperUtils, Q.placements = W, Q.Defaults = K, Q;
}), function (e, t) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && void 0 !== module ? t(exports, require("jquery"), require("popper.js")) : "function" == typeof define && define.amd ? define(["exports", "jquery", "popper.js"], t) : t(e.bootstrap = {}, e.jQuery, e.Popper);
}(this, function (e, t, n) {
  "use strict";
  function i(e, t) {
    for (var n = 0; n < t.length; n++) {
  ...
  var t = 1,
      ...
      C = 10,
      _ = Math.ceil,
      T = Math.floor;function x(e, t) {
    var n = e.getTime();return e.setMonth(e.getMonth() + t), Math.round((e.getTime() - n) / v);
  }function k(e) {
    var t = e.getTime(),
        n = new Date(t);return n.setMonth(e.getMonth() + 1), Math.round((n.getTime() - t) / v);
  }function S(e, t) {
    if (t = t instanceof Date || null !== t && isFinite(t) ? new Date(+t) : new Date(), !e) return t;var n = +e.value || 0;return n ? (t.setTime(t.getTime() + n), t) : ((n = +e.milliseconds || 0) && t.setMilliseconds(t.getMilliseconds() + n), (n = +e.seconds || 0) && t.setSeconds(t.getSeconds() + n), (n = +e.minutes || 0) && t.setMinutes(t.getMinutes() + n), (n = +e.hours || 0) && t.setHours(t.getHours() + n), (n = +e.weeks || 0) && (n *= y), (n += +e.days || 0) && t.setDate(t.getDate() + n), (n = +e.months || 0) && t.setMonth(t.getMonth() + n), (n = +e.millennia || 0) && (n *= C), (n += +e.centuries || 0) && (n *= E), (n += +e.decades || 0) && (n *= w), (n += +e.years || 0) && t.setFullYear(t.getFullYear() + n), t);
  }var A, D, I, N, P, L, O, M;function j(e, t) {
    return O(e) + (1 === e ? A[t] : D[t]);
  }function H() {}function F(e, t, n, i, r, o) {
    return e[n] >= 0 && (t += e[n], delete e[n]), (t /= r) + 1 <= 1 ? 0 : e[i] >= 0 ? (e[i] = +(e[i] + t).toFixed(o), function (e, t) {
      switch (t) {case "seconds":
          if (e.seconds !== p || isNaN(e.minutes)) return;e.minutes++, e.seconds = 0;case "minutes":
          if (e.minutes !== m || isNaN(e.hours)) return;e.hours++, e.minutes = 0;case "hours":
          if (e.hours !== g || isNaN(e.days)) return;e.days++, e.hours = 0;case "days":
          if (e.days !== y || isNaN(e.weeks)) return;e.weeks++, e.days = 0;case "weeks":
          if (e.weeks !== k(e.refMonth) / y || isNaN(e.months)) return;e.months++, e.weeks = 0;case "months":
          if (e.months !== b || isNaN(e.years)) return;e.years++, e.months = 0;case "years":
          if (e.years !== w || isNaN(e.decades)) return;e.decades++, e.years = 0;case "decades":
          if (e.decades !== E || isNaN(e.centuries)) return;e.centuries++, e.decades = 0;case "centuries":
          if (e.centuries !== C || isNaN(e.millennia)) return;e.millennia++, e.centuries = 0;}
    }(e, i), 0) : t;
  }function q(e, t) {
    var n,
        i,
        r,
        o = F(e, 0, "milliseconds", "seconds", f, t);if (o && (o = F(e, o, "seconds", "minutes", p, t)) && (o = F(e, o, "minutes", "hours", m, t)) && (o = F(e, o, "hours", "days", g, t)) && (o = F(e, o, "days", "weeks", y, t)) && (o = F(e, o, "weeks", "months", k(e.refMonth) / y, t)) && (o = F(e, o, "months", "years", (n = e.refMonth, i = n.getTime(), (r = new Date(i)).setFullYear(n.getFullYear() + 1), Math.round((r.getTime() - i) / v) / k(e.refMonth)), t)) && (o = F(e, o, "years", "decades", w, t)) && (o = F(e, o, "decades", "centuries", E, t)) && (o = F(e, o, "centuries", "millennia", C, t))) throw new Error("Fractional unit overflow");
  }function B(e, h, v, k, S, A) {
    var D = new Date();if (e.start = h = h || D, e.end = v = v || D, e.units = k, e.value = v.getTime() - h.getTime(), e.value < 0) {
      var I = v;v = h, h = I;
    }e.refMonth = new Date(h.getFullYear(), h.getMonth(), 15, 12, 0, 0);try {
      e.millennia = 0, e.centuries = 0, e.decades = 0, e.years = v.getFullYear() - h.getFullYear(), e.months = v.getMonth() - h.getMonth(), e.weeks = 0, e.days = v.getDate() - h.getDate(), e.hours = v.getHours() - h.getHours(), e.minutes = v.getMinutes() - h.getMinutes(), e.seconds = v.getSeconds() - h.getSeconds(), e.milliseconds = v.getMilliseconds() - h.getMilliseconds(), function (e) {
        var t;for (e.milliseconds < 0 ? (t = _(-e.milliseconds / f), e.seconds -= t, e.milliseconds += t * f) : e.milliseconds >= f && (e.seconds += T(e.milliseconds / f), e.milliseconds %= f), e.seconds < 0 ? (t = _(-e.seconds / p), e.minutes -= t, e.seconds += t * p) : e.seconds >= p && (e.minutes += T(e.seconds / p), e.seconds %= p), e.minutes < 0 ? (t = _(-e.minutes / m), e.hours -= t, e.minutes += t * m) : e.minutes >= m && (e.hours += T(e.minutes / m), e.minutes %= m), e.hours < 0 ? (t = _(-e.hours / g), e.days -= t, e.hours += t * g) : e.hours >= g && (e.days += T(e.hours / g), e.hours %= g); e.days < 0;) {
          e.months--, e.days += x(e.refMonth, 1);
        }e.days >= y && (e.weeks += T(e.days / y), e.days %= y), e.months < 0 ? (t = _(-e.months / b), e.years -= t, e.months += t * b) : e.months >= b && (e.years += T(e.months / b), e.months %= b), e.years >= w && (e.decades += T(e.years / w), e.years %= w, e.decades >= E && (e.centuries += T(e.decades / E), e.decades %= E, e.centuries >= C && (e.millennia += T(e.centuries / C), e.centuries %= C)));
      }(e), function (e, h, v, _) {
        var k = 0;!(h & d) || k >= v ? (e.centuries += e.millennia * C, delete e.millennia) : e.millennia && k++, !(h & u) || k >= v ? (e.decades += e.centuries * E, delete e.centuries) : e.centuries && k++, !(h & c) || k >= v ? (e.years += e.decades * w, delete e.decades) : e.decades && k++, !(h & l) || k >= v ? (e.months += e.years * b, delete e.years) : e.years && k++, !(h & a) || k >= v ? (e.months && (e.days += x(e.refMonth, e.months)), delete e.months, e.days >= y && (e.weeks += T(e.days / y), e.days %= y)) : e.months && k++, !(h & s) || k >= v ? (e.days += e.weeks * y, delete e.weeks) : e.weeks && k++, !(h & o) || k >= v ? (e.hours += e.days * g, delete e.days) : e.days && k++, !(h & r) || k >= v ? (e.minutes += e.hours * m, delete e.hours) : e.hours && k++, !(h & i) || k >= v ? (e.seconds += e.minutes * p, delete e.minutes) : e.minutes && k++, !(h & n) || k >= v ? (e.milliseconds += e.seconds * f, delete e.seconds) : e.seconds && k++, h & t && !(k >= v) || q(e, _);
      }(e, k, S, A);
    } finally {
      delete e.refMonth;
    }return e;
  }function R(e, s, a, l, c) {
    var u;a = +a || h, l = l > 0 ? l : NaN, c = c > 0 ? c < 20 ? Math.round(c) : 20 : 0;var d = null;"function" == typeof e ? (u = e, e = null) : e instanceof Date || (null !== e && isFinite(e) ? e = new Date(+e) : ("object" == (typeof d === "undefined" ? "undefined" : _typeof(d)) && (d = e), e = null));var v = null;if ("function" == typeof s ? (u = s, s = null) : s instanceof Date || (null !== s && isFinite(s) ? s = new Date(+s) : ("object" == (typeof s === "undefined" ? "undefined" : _typeof(s)) && (v = s), s = null)), d && (e = S(d, s)), v && (s = S(v, e)), !e && !s) return new H();if (!u) return B(new H(), e, s, a, l, c);var b,
        w = function (e) {
      return e & t ? f / 30 : e & n ? f : e & i ? f * p : e & r ? f * p * m : e & o ? f * p * m * g : f * p * m * g * y;
    }(a),
        E = function E() {
      u(B(new H(), e, s, a, l, c), b);
    };return E(), b = setInterval(E, w);
  }H.prototype.toString = function (e) {
    var t = M(this),
        n = t.length;if (!n) return e ? "" + e : P;if (1 === n) return t[0];var i = I + t.pop();return t.join(N) + i;
  }, H.prototype.toHTML = function (e, t) {
    e = e || "span";var n = M(this),
        i = n.length;if (!i) return (t = t || P) ? "<" + e + ">" + t + "</" + e + ">" : t;for (var r = 0; r < i; r++) {
      n[r] = "<" + e + ">" + n[r] + "</" + e + ">";
    }if (1 === i) return n[0];var o = I + n.pop();return n.join(N) + o;
  }, H.prototype.addTo = function (e) {
    return S(this, e);
  }, M = function M(e) {
    var t = [],
        n = e.millennia;return n && t.push(L(n, 10)), (n = e.centuries) && t.push(L(n, 9)), (n = e.decades) && t.push(L(n, 8)), (n = e.years) && t.push(L(n, 7)), (n = e.months) && t.push(L(n, 6)), (n = e.weeks) && t.push(L(n, 5)), (n = e.days) && t.push(L(n, 4)), (n = e.hours) && t.push(L(n, 3)), (n = e.minutes) && t.push(L(n, 2)), (n = e.seconds) && t.push(L(n, 1)), (n = e.milliseconds) && t.push(L(n, 0)), t;
  }, R.MILLISECONDS = t, R.SECONDS = n, R.MINUTES = i, R.HOURS = r, R.DAYS = o, R.WEEKS = s, R.MONTHS = a, R.YEARS = l, R.DECADES = c, R.CENTURIES = u, R.MILLENNIA = d, R.DEFAULTS = h, R.ALL = d | u | c | l | a | s | o | r | i | n | t;var z = R.setFormat = function (e) {
    if (e) {
      if ("singular" in e || "plural" in e) {
        var t = e.singular || [];t.split && (t = t.split("|"));var n = e.plural || [];n.split && (n = n.split("|"));for (var i = 0; i <= 10; i++) {
          A[i] = t[i] || A[i], D[i] = n[i] || D[i];
        }
      }"string" == typeof e.last && (I = e.last), "string" == typeof e.delim && (N = e.delim), "string" == typeof e.empty && (P = e.empty), "function" == typeof e.formatNumber && (O = e.formatNumber), "function" == typeof e.formatter && (L = e.formatter);
    }
  },
      W = R.resetFormat = function () {
    A = " millisecond| second| minute| hour| day| week| month| year| decade| century| millennium".split("|"), D = " milliseconds| seconds| minutes| hours| days| weeks| months| years| decades| centuries| millennia".split("|"), I = " and ", N = ", ", P = "", O = function O(e) {
      return e;
    }, L = j;
  };return R.setLabels = function (e, t, n, i, r, o, s) {
    z({ singular: e, plural: t, last: n, delim: i, empty: r, formatNumber: o, formatter: s });
  }, R.resetLabels = W, W(), e && e.exports ? e.exports = R : "function" == typeof window.define && void 0 !== window.define.amd && window.define("countdown", [], function () {
    return R;
  }), R;
}(module);!function (e, t) {
  ...
  "use strict";
  "function" == typeof define && define.amd ? define(["jquery"], e) : void 0 !== module && module.exports ? module.exports = e(require("jquery")) : e(jQuery);
}(function (e) {
  "use strict";
  ...
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && void 0 !== module ? module.exports = t() : "function" == typeof define && define.amd ? define("Plyr", t) : e.Plyr = t();
}(this, function () {
  "use strict";
  "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self && self;var e,
    ...
    function e(t) {
      ...
      M = { insertElements: function insertElements(e, t) {
  ...
  var ArrayProto = Array.prototype,
    ...
    var i = this,
      ...
      var a,
          ...
          O = {},
          M = [],
          j = isWindow(e);i.frame = e, i.options = D, i.parents = I, i.initialized = !1, i.reload = F;var H = function H(e, t) {
        var n = $(t),
        ...
        return $.isPlainObject(e) ? $.extend(D, e) : hasOwnProperty.call(D, e) && (D[e] = t), F(), i;
      }, i.destroy = function () {
        return unbind(window, "resize", q), unbind(e, "scroll", B), $.each(o, function (t, n) {
          t && t.frame === e && splice.call(Scrollax.instances, n, 1);
        }), I.length = 0, i.initialized = !1, W("destroy"), i;
      }, i.init = function () {
        if (!i.initialized) return i.on(n), F(), bind(window, "resize", q), bind(e, "scroll", B), push.call(Scrollax.instances, i), i.initialized = !0, W("initialized"), i;
      };
    } else warn(s ? namespace + ": Scrollax has been initialized for this frame!" : namespace + ": Frame is not available!");function F() {
      return N = j ? $doc.find(P) : r.find(P), I.length = 0, p = !!D.horizontal, N.each(H), B(), D.performanceTrick && (u = j ? $doc : r), W("load"), i;
    }function q() {
      ...
      if (O[e]) {
        for (c = O[e].length, M.length = 0, l = 0; l < c; l++) {
          push.call(M, O[e][l]);
        }for (l = 0; l < c; l++) {
          M[l].call(i, e, t);
        }
  ...
  var t = {},
    ...
    var n = e("body");1 != e(".lv-screen-data").length && n.append('<div class="lv-screen-data"></div>');var i,
        ...
        a = e(window).width(),
        l = e(window).height();o < t.sm && (i = "xs"), o >= t.sm && o < t.md && (i = "sm"), o >= t.md && o < t.lg && (i = "md"), o >= t.lg && o < t.xl && (i = "lg"), o >= t.xl && o < t.xxl && (i = "xl"), o >= t.xxl && (i = "xxl"), a < t.sm && (r = "xs"), a >= t.sm && a < t.md && (r = "sm"), a >= t.md && a < t.lg && (r = "md"), a >= t.lg && a < t.xl && (r = "lg"), a >= t.xl && a < t.xxl && (r = "xl"), a >= t.xxl && (r = "xxl"), e(".lv-screen-data").html(a + " x " + l + "<br><small>" + o + " x " + s + "</small><br>" + i + "  [" + r + "]").css({ position: "fixed", top: 0, padding: "5px 10px", background: "rgba(0,0,0,0.5)", "font-family": "Helvetica Neue", "font-size": "14px", color: "white", "z-index": 2147483646 }).click(function () {
